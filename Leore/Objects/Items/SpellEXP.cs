        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (!Taken)
            {
                ...
                else
                {
                    ...
                    if (player.Stats.Abilities.HasFlag(PlayerAbility.ORB) && player.HP > 0 && MathUtil.Euclidean(Center, player.Center) > 1 && MathUtil.Euclidean(Center, player.Center) < 4 * Globals.T)
                    {
                        kinetic = false;
